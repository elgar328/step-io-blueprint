...
| file | schema | source |
|---|---|---|
| `ap203.exp` | AP203 (Configuration Controlled 3D Design) | [STEPCode](https://github.com/stepcode/stepcode) `data/ap203/` (BSD-3-Clause) |
| `ap203e2_mim_lf.exp` | AP203 Edition 2 (2011) | STEPCode `data/ap203e2/` |
| `ap214e3.exp` | AP214 Edition 3 (2010) | STEPCode `data/ap214e3/` |
| `ap242_mim_lf.exp` | AP242 Edition 1 (2014) | STEPCode `data/ap242/` |
| `ap242ed2_dis2_mim_lf_v1.101.exp` | AP242 Edition 2 (2019, N10517) | [MBx-IF](https://www.mbx-if.org/home/mbx/resources/express-schemas/) |
