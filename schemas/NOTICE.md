...
| file | schema | source (upstream file) |
|---|---|---|
| `ap203.exp` | AP203 Edition 1 (1994) | STEPCode (`ap203.exp`) |
...
| `ap242ed2_dis2_mim_lf_v1.101.exp` | AP242 Edition 2 (2019) | MBx-IF (`ap242ed2_dis2_mim_lf_v1.101`) |
| `ap242ed3_mim_lf_v1.152.exp` | AP242 Edition 3 (2022) | MBx-IF (`ap242ed3_mim_lf_v1.152`) |
